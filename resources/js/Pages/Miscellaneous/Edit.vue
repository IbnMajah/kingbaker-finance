  ...
  <div>
    ...
    <div class="mb-8">
      <h1 class="text-3xl font-bold mb-2">
        ...
        <Link :href="`/miscellaneous/${transaction.id}`" class="text-brand-400 hover:text-brand-600">{{ transaction.reference_number }}</Link>
        <span class="text-brand-400 font-medium">/</span>
        Edit
      </h1>
      <p class="text-gray-600">Update transaction details and information</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div class="px-6 py-4 border-b border-gray-200">
        ...
        <p class="text-sm text-gray-600 mt-1">Update the details for this miscellaneous transaction</p>
      </div>
      ...
      <form @submit.prevent="update">
          ...
          <div class="border-t border-gray-200 pt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div v-if="transaction.receipt_image_path" class="mb-2">
                  <img :src="transaction.receipt_image_path" alt="Receipt" class="h-20 w-auto rounded">
                  <button
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
          <Link :href="`/miscellaneous/${transaction.id}`" class="text-gray-600 hover:text-gray-800">
...
export default {
  ...
  methods: {
    update() {
      this.form.put(`/miscellaneous/${this.transaction.id}`)
    },
    removeImage() {
      if (confirm('Are you sure you want to remove the receipt image?')) {
        this.$inertia.post(`/miscellaneous/${this.transaction.id}/remove-image`)
      }
    },
  },
}
