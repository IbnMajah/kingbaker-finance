    ...
    <div v-if="hasPermission('view_reports')" class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8">
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Total Bills</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ bills.total || 0 }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Paid Bills</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ paidCount }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            ...
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ pendingCount }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            ...
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900"><MaskableAmount :value="$formatAmount(currentMonthTotal)" /></p>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        <table class="w-full">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="w-28 px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Due Date</th>
      ...
      <div v-if="bills?.data?.length" class="px-6 py-4 border-t border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <Pagination v-if="bills.links" :links="bills.links" />
        </div>
      </div>
    </div>
...
export default {
  ...
  layout: Layout,
  setup() {
    const { canCreateBills, canViewBills, canEditBills, hasPermission } = usePermissions()
    return { canCreateBills, canViewBills, canEditBills, hasPermission }
  },
  props: {
    filters: {
      type: Object,
