    ...
    <div v-if="hasPermission('view_reports')" class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8">
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            ...
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ summary.total_transactions || 0 }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Pending Reconciliation</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ summary.pending_reconciliation || 0 }}</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <table class="w-full table-fixed">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Bank Account</th>
              ...
              <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Payee</th>
...
export default {
  ...
  layout: Layout,
  setup() {
    const { canViewTransactions, hasPermission } = usePermissions()
    return { canViewTransactions, hasPermission }
  },
  props: {
    filters: {
      type: Object,
