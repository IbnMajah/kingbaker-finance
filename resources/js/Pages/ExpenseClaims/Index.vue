    ...
    <div v-if="hasPermission('view_reports')" class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-6 mb-8">
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Total Claims</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ totalClaims }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Active Claims</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ activeClaims }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            <p class="text-xs md:text-sm font-medium text-gray-600">Draft Claims</p>
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900">{{ draftClaims }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow p-3 md:p-6">
        <div class="flex items-center">
          ...
          <div class="lg:ml-4">
            ...
            <p class="text-lg md:text-xl lg:text-2xl font-semibold text-gray-900"><MaskableAmount :value="$formatAmount(totalAmount)" /></p>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div v-if="claims?.data?.length" class="px-6 py-4 border-t border-gray-200">
        <div class="flex items-center justify-between">
          ...
          <Pagination v-if="claims.links" :links="claims.links" />
        </div>
      </div>
    </div>
...
export default {
  ...
  layout: Layout,
  setup() {
    const { canCreateExpenses, canViewExpenses, canEditExpenses, hasPermission } = usePermissions()
    return { canCreateExpenses, canViewExpenses, canEditExpenses, hasPermission }
  },
  props: {
    filters: {
      type: Object,
