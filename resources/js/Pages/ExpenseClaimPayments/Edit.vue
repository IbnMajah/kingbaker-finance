<template>
  <div>
    <Head :title="`Edit Payment - ${expenseClaim.claim_number || `Expense Claim #${expenseClaim.id}`}`" />
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600">Edit payment for this expense claim</p>
    </div>
      ...
      <form @submit.prevent="updatePayment">
        <div class="p-6 space-y-6">
          ...
          <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Amount must match expense claim total: {{ $formatAmount(expenseClaim.total) }}</p>
...
export default {
  ...
  methods: {
    updatePayment() {
      this.form.put(`/expense-claim-payments/${this.payment.id}`, {
        onSuccess: () => {
