...
export default {
  ...
  layout: Layout,
  setup() {
    const { canCreateChequePayments, canViewChequePayments, canEditChequePayments, hasPermission } = usePermissions()
    return { canCreateChequePayments, canViewChequePayments, canEditChequePayments, hasPermission }
  },
  props: {
    payments: Object,
    summary: Object,
