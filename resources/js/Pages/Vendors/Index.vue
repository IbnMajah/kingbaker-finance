  ...
  <div>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <Link v-if="canCreateVendors" class="btn-kingbaker" href="/vendors/create">
            ...
            <tr v-for="vendor in vendors?.data || []" :key="vendor.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-center">
                <div class="flex items-center justify-center space-x-2">
                  <Link v-if="canViewVendors" class="flex items-center space-x-1 text-brand-600 hover:text-brand-900 text-sm font-medium" :href="`/vendors/${vendor.id}`">
                  ...
                  <Link v-if="canEditVendors" class="flex items-center space-x-1 text-gray-600 hover:text-gray-900 text-sm font-medium" :href="`/vendors/${vendor.id}/edit`">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
