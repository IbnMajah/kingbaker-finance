...
export default {
  ...
  mounted() {
    // Set the initial customer_id if we have customer data
    if (this.invoice.customer_name) {
      const customer = this.customers.find(c => c.name === this.invoice.customer_name)
      if (customer) {
